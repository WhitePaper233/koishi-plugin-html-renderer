...
class HTMLRenderer extends koishi_1.Service {
    ...
    async start() {
        // 检查浏览器是否安装
        const chromium_path = playwright_1.chromium.executablePath();
        const firefox_path = playwright_1.firefox.executablePath();
        const webkit_path = playwright_1.webkit.executablePath();
    ...
    install_browser() {
        ...
        let install_command = "npx playwright install-deps";
        ...
        (0, child_process_1.exec)(install_command, (error) => {
            if (error) {
